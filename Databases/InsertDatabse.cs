...
//                             break;
//                     }
//                     InsertIntoDatabase(randomName, line);
//                 }
//                 i++;
//             }
...
//     private static void InsertIntoDatabase(string name, string text)
//     {
...
//             string randomNIK = Guid.NewGuid().ToString("N").Substring(0, 16);
...
//         {
//             namesArray[i] = commonNames[random.Next(commonNames.Length)];
//         }
